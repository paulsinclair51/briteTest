...
# shellcheck source=briteRepo/helpers/common.sh
source "$REPO_ROOT/briteRepo/helpers/common.sh"
# shellcheck source=briteRepo/helpers/report_helpers.sh
source "$REPORT_HELPER_SRC"
# shellcheck source=briteRepo/helpers/history_log.sh
