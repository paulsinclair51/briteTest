...
This guide explains how to use LiteTest effectively: concepts, workflow,
execution model, examples, and practical usage patterns. It complements
the **LiteTest API Reference**, which documents the public API in detail.
