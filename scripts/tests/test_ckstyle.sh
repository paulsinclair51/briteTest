...
assert_contains "Output verbose progress and diagnostics to stderr." "$TMPDIR/help.out"
pass "help output"
...
assert_contains "See <repo>/reports/guidelines/ckstyle-" "$TMPDIR/default.out"
...
assert_contains "See <repo>/reports/guidelines/ckstyle-" "$TMPDIR/invalid-doc.out"
