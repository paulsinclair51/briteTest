...
This file contains a history of local branch operations.

Copyright (c) 2026 Paul Sinclair  
SPDX-License-Identifier: MIT  
For license details, see `<repo>/LICENSE`.

This file is committed to local `main` but not pushed to remote `main`.

See `<repo>/docs/md/Contributor_Guide.md` for details on logging local
branch history.
